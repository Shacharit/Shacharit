...
public class FlowLayout extends ViewGroup implements View.OnClickListener {
    ...
    private void init() {
        paddingHorizontal = getResources().getDimensionPixelSize(org.shaharit.face2face.R.dimen.flowlayout_horizontal_padding);
        paddingVertical = getResources().getDimensionPixelSize(org.shaharit.face2face.R.dimen.flowlayout_vertical_padding);
    }
    ...
    public void onClick(View view) {
        ...
        if (!isChecked) {
            ...
            if (1 == maxItems) {
                Toast.makeText(getContext(), getContext().getString(org.shaharit.face2face.R.string.oneitemlimit), Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(getContext(), String.format(getContext().getString(org.shaharit.face2face.R.string.itemlimit), maxItems), Toast.LENGTH_SHORT).show();
            }
        } else {
            nChecked++;
        }
